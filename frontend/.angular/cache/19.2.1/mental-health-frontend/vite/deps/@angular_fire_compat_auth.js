import {
  firebase
} from "./chunk-4AXRYL4Z.js";
import {
  AppCheckInstances
} from "./chunk-VAU53BZE.js";
import "./chunk-22WF3Y4Q.js";
import {
  VERSION as VERSION2,
  pendingUntilEvent,
...
import "./chunk-ENLTBW45.js";
import {
  isPlatformServer
} from "./chunk-MG5EXAF7.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name2, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-M3WA754G.js"))), map(() => ɵfirebaseAppFactory(options, zone, name2)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
